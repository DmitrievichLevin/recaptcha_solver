...
Welcome to ``recaptcha_solver`` contributor's guide.
...
If you experience bugs or general issues with ``recaptcha_solver``, please have a look
...
You can help improve ``recaptcha_solver`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``recaptcha_solver`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``recaptcha_solver``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n recaptcha_solver python=3 six virtualenv pytest pytest-cov
    conda activate recaptcha_solver
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/recaptcha_solver.git
    cd recaptcha_solver
...
#. Install |pre-commit|_::
   ...
   ``recaptcha_solver`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/recaptcha_solver
.. _issue tracker: https://github.com/<USERNAME>/recaptcha_solver/issues
.. <-- end -->
